  ...
  return (
    <View className="flex-1 bg-background">
      ...
      >
        ...
        <Text
          className={`text-muted-foreground font-bold uppercase tracking-widest ${isTablet ? 'text-sm mb-2' : 'text-xs mb-1'}`}
        >
          Adjusting Stock For
        </Text>
        <Text
          className={`font-black uppercase text-foreground tracking-tighter ${isTablet ? 'text-5xl' : 'text-3xl'}`}
          numberOfLines={1}
          ...
          <View className={`w-full ${isTablet ? 'max-w-md self-center' : ''}`}>
            ...
            <View className="flex-row gap-3 mb-6">
              <Button
                ...
                className="flex-1"
                textClassName={
                  isTablet ? '' : 'text-xs font-black tracking-widest'
                }
              />
              <Button
                title="- REDUCE"
